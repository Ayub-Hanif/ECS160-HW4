...
public class SessionTest {
    ...
    void multiple_posts_with_list_2() {
        ...
        System.out.println("post 1 replies");
        System.out.println(loadedPost1.get_post_replies().get(0).get_post_Id());
        System.out.println(loadedPost1.get_post_replies().get(1).get_post_Id());
        System.out.println(loadedPost1.get_post_replies().get(2).get_post_Id());
        assertEquals(2, loadedPost1.get_post_replies().get(0).get_post_Id());
        assertEquals("other test heh content hehaef test", loadedPost1.get_post_replies().get(0).get_post_content());
        assertEquals(6, loadedPost1.get_post_replies().get(0).get_word_count());
        ...
        System.out.println("post 2 replies");
        System.out.println(loadedPost2.get_post_replies().get(0).get_post_Id());
        System.out.println(loadedPost2.get_post_replies().get(1).get_post_Id());
